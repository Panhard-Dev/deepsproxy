...
const DEFAULT_OPEN = "<tool_call>";
const DEFAULT_CLOSE = "</tool_call>";

export const TOOL_CALL_OPEN: string =
  (process.env.DEEPSEEK_TOOL_OPEN || DEFAULT_OPEN).trim() || DEFAULT_OPEN;
export const TOOL_CALL_CLOSE: string =
  (process.env.DEEPSEEK_TOOL_CLOSE || DEFAULT_CLOSE).trim() || DEFAULT_CLOSE;
